...
/**
	...
	public function getInvestContractData($ivsid){
		...
		->field("g.*,
		concat(f.title,i.cod_period,'期') as periodname, 
		a.*,(c.startdate) as z_startdate,(c.enddate) as z_enddate,(c.period) as z_period,
		(c.amt_cf_inv_price) as z_amt_cf_inv_price,(c.product_name) as z_product_name,(c.address) as z_address,(c.borrower) as z_borrower,(c.cod_card_type) as z_cod_card_type,(c.cod_card_no) as z_cod_card_no,(c.telephone) as z_telephone
		,d.nam_cust_real as k_nam_cust_real,d.cod_cust_id_type as k_cod_cust_id_type,d.cod_cust_id_no as k_cod_cust_id_no,e.address as k_address,d.tel as k_tel")
