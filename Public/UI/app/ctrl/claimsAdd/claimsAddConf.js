 ...
 */
Ext.define('ui.ctrl.claimsAdd.claimsAddConf',{
    ...
    _urls : {
        'get.claimsAdd.list' : { url : "claims/getClaimslist" , 'pmsCode' : 'get.claimsAdd.list' , checkpms : 0 },
        'get.claimsAdd.view' : { url : "claims/getClaimsinfo" , 'pmsCode' : 'get.claimsAdd.info' , checkpms : 0 },
        'get.claimsAdd.cfMast' : { url : "claims/cfMastSelect" , 'pmsCode' : 'get.claimsAdd.cfMast' , checkpms : 0 },
        'get.claimsAdd.edit' : { url : "claims/saveClaims" , 'pmsCode' : 'set.claimsAdd.info' , checkpms : 0 },
        'set.claimsAdd.delete' : { url : "claims/recyClaims" , 'pmsCode' : 'set.claimsAdd.delete' , checkpms : 0 },
        'set.claimsAdd.submit' : { url : "claims/claimSubmit" , 'pmsCode' : 'set.claimsAdd.delete' , checkpms : 0 },
        'get.claimsTypelist' : { url : "Foundation/allFoundation" , 'pmsCode' : 'get.claimsTypelist' , checkpms : 0 }
    },
    _opButtons : [
        { text : '新建+' , pmsCode : 'claimsAdd.add' ,recKey : ['id']  , checkpms:0 },
        { text : '批量删除-' , pmsCode : 'claimsAdd.cexiao' ,recKey : ['id']  , checkpms:0 }
    ],
    _lstOpButtons : [
        { text : '查看' , pmsCode : 'claimsAdd.view' , recKey : ['id']/*所需record之关键字列表*/  , checkpms:1, iconCls : ''},
        { text : '编辑' , pmsCode : 'claimsAdd.edit' , recKey : ['id']/*所需record之关键字列表*/  , checkpms:1 ,iconCls : ''},
        { text : '提交' , pmsCode : 'claimsAdd.submit' , recKey : ['id']/*所需record之关键字列表*/  , checkpms:1 ,iconCls : ''},
        { text : '删除' , pmsCode : 'claimsAdd.delete' , recKey : ['id']/*所需record之关键字列表*/  , checkpms:1 ,iconCls : ''}
        // { text : '删除' , pmsCode : 'claimsAdd.delete' , recKey : ['id']/*所需record之关键字列表*/  , checkpms:1 ,iconCls : ''}
    ],
    _scFields : [
        {fieldLabel : '债权状态' ,labelWidth : 70, width:190 ,name : 'status' , fieldtype : 'Ext.form.field.ComboBox', pmsCode:'' , checkpms:0,
            ...
            store : Ext.create('Ext.data.ArrayStore',{
				...
				proxy: Ext.create( 'ui.extend.base.Ajax',{
                    url : '/Admin/Claims/getStatusSelect/type/1'
                })
            })
        },
...
/*				proxy: Ext.create( 'ui.extend.base.Ajax',{
                    url : '/Admin/Claims/getInsertSelect/type/1'
                })*/
            }), pmsCode:'' , checkpms:0   },
    ...
    * */
	...
	getMaster : function(key , params , theform){ 
		...
		console.log(form.findField("type"))
		console.log(form.findField("type").fieldLabel)
		console.log(form.findField("type").getStore())
        var me = this;
        return new Ext.data.ArrayStore({
            fields  :   ['id', 'title'] ,           
            autoLoad : true,
            proxy: Ext.create('ui.extend.base.Ajax',{
				extraParams : {type : 1}, //department_id
                url : me.urls.get('get.claimsTypelist').url //'../productCategory/getLeavelOne'
            })
        })
    }
});