 ...
 */
Ext.define('ui.ctrl.investmentproductpublish.investmentproductpublishConf',{
    extend: 'ui.extend.baseClass.baseConf',
    modelName : "投资产品发布",
    topicalName : '投资产品发布',
    modelCode : 'investmentproductpublish',
    groupCode : '',
    ...
    _urls : {
        'get.investmentproductpublish.list' : { url : "cfmast/getUnpublicProduct" , 'pmsCode' : 'get.investmentproductpublish.list' , checkpms : 0 },
        'get.investmentproductpublish.view' : { url : "cfmast/tdetail" , 'pmsCode' : 'get.investmentproductpublish.info' , checkpms : 0 },
        'get.investmentproductpublish.getfiles' : { url : "cfmast/getFileList" , 'pmsCode' : 'get.investmentproductpublish.getfiles' , checkpms : 0 },
        'get.investmentproductpublish.edit' : { url : "claims/saveClaims" , 'pmsCode' : 'set.investmentproductpublish.info' , checkpms : 0 },
        'set.investmentproductpublish.publish' : { url : "cfmast/releasemast" , 'pmsCode' : 'set.investmentproductpublish.publish' , checkpms : 0 },
        'set.investmentproductpublish.reject' : { url : "cfmast/publicBack" , 'pmsCode' : 'set.investmentproductpublish.reject' , checkpms : 0 }
    },
    _opButtons : [
        // { text : '新建+' , pmsCode : 'investmentproductpublish.add' ,recKey : ['id']  , checkpms:0 }
        // { text : '批量删除-' , pmsCode : 'investmentproductpublish.disable' ,recKey : ['id']  , checkpms:0 }
    ],
    _lstOpButtons : [
        { text : '查看' , pmsCode : 'investmentproductpublish.view' , recKey : ['id']/*所需record之关键字列表*/  , checkpms:1, iconCls : ''},
        { text : '发布' , pmsCode : 'investmentproductpublish.publish' , recKey : ['id']/*所需record之关键字列表*/  , checkpms:1 ,iconCls : ''},
        { text : '退回' , pmsCode : 'investmentproductpublish.reject' , recKey : ['id']/*所需record之关键字列表*/  , checkpms:1 ,iconCls : ''}
    ],
    _scFields : [
