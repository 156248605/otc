...
<div class="box">
	<div class="login-box">
		...
		<div class="login-content ">
			<div class="form">
				<form action="/common/register.html" method="post" autocomplete="off">
					...
					<div class="next-step" style="display: none;">
						...
						<!--<div class="form-group">-->
							...
							<!--</div>-->
						<!--</div>-->
						<input type="hidden" id="organization" name="organization_id" value="1">
						<div class="form-group">
							<div class="col-xs-12">
								<div class="input-group">
...
//	alert(screenW);
	...
	$('#job').change(function(){
		...
		if(job_id){
			$.getJSON(
					'/Admin/Common/leaderList?position_id='+job_id,
					function(_data){
