 ...
 */
Ext.define('ui.ctrl.claimsaudit.claimsauditConf',{
    extend: 'ui.extend.baseClass.baseConf',
    modelName : "债权审核",
    topicalName : '债权审核',
    modelCode : 'claimsaudit',
    groupCode : '',
    ...
    _urls : {
        'get.claimsaudit.list' : { url : "claims/getClaimsAuditList" , 'pmsCode' : 'get.claimsaudit.list' , checkpms : 0 },
        'get.claimsaudit.view' : { url : "claims/getClaimsinfo" , 'pmsCode' : 'get.claimsaudit.info' , checkpms : 0 },
        'get.claimsaudit.getfiles' : { url : "claims/claimAllUploadFile" , 'pmsCode' : 'get.claimsaudit.getfiles' , checkpms : 0 },
        'get.claimsaudit.edit' : { url : "claims/saveClaims" , 'pmsCode' : 'set.claimsaudit.info' , checkpms : 0 },
        'get.claimsaudit.downfile' : { url : "claims/downfile" , 'pmsCode' : 'get.claimsaudit.downfile' , checkpms : 0 },
        'set.claimsaudit.change' : { url : "claims/auditClaims" , 'pmsCode' : 'set.claimsaudit.change' , checkpms : 0 },
        'set.claimsaudit.upload' : { url : "claims/claimFileUpload" , 'pmsCode' : 'set.claimsaudit.upload' , checkpms : 0 },
        'set.claimsaudit.deleteupload' : { url : "claims/claimDelUploadFile" , 'pmsCode' : 'set.claimsaudit.deleteupload' , checkpms : 0 }
    },
    _opButtons : [
        // { text : '新建+' , pmsCode : 'claimsaudit.add' ,recKey : ['id']  , checkpms:0 }
        // { text : '批量删除-' , pmsCode : 'claimsaudit.disable' ,recKey : ['id']  , checkpms:0 }
    ],
    _lstOpButtons : [
        { text : '查看' , pmsCode : 'claimsaudit.view' , recKey : ['id']/*所需record之关键字列表*/  , checkpms:1, iconCls : ''},
      //  { text : '上传资料' , pmsCode : 'claimsaudit.upload' , recKey : ['id']/*所需record之关键字列表*/  , checkpms:1 ,iconCls : ''},
        { text : '通过' , pmsCode : 'claimsaudit.approve' , recKey : ['id','status']/*所需record之关键字列表*/  , checkpms:1 ,iconCls : ''},
        { text : '退回' , pmsCode : 'claimsaudit.reject' , recKey : ['id','status']/*所需record之关键字列表*/  , checkpms:1 ,iconCls : ''}
    ],
    _scFields : [
