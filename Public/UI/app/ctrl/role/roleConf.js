...
Ext.define('ui.ctrl.role.roleConf',{
    ...
    _opButtons : [
        { text : '新建角色+' , pmsCode : 'role.add' ,recKey : ['id'] ,'permissionCode' : "role.add" , checkpms:1 },
    ...
    _lstOpButtons : [
        ...
        { text : '启用' , pmsCode : 'role.enable' , recKey : ['id','status']/*所需record之关键字列表*/  , checkpms:1 ,iconCls : '','permissionCode' : "role.start"}
    ],
